...
describe('CreateBookScreenStore', () => {
  ...
  it('Форматирует values формы в формат необходимый для создания книги', async () => {
  ...
  it('Показывает уведомление при успешном создании книги', async () => {
  ...
  it('Редиректит на страницу списка книг после успешного создания книги', async () => {
